...
export function ClaimToObjection(cell:joint.dia.Cell) {
    ...
    //links
    let links:Array<joint.dia.Link> = graph.getConnectedLinks(cell, {outbound:true})
...
export function ObjectionToClaim(cell:joint.dia.Cell) {
